...
//         print_r($cond);die(0);
        $sql = "select id_user,username,nama,id_sttsuser,email  from user where username=lower('" . $condition['username'] . "') and password='" . $cond['password'] . "'";
//                  print_r($sql);die(0);
