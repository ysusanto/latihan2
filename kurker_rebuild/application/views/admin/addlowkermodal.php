            ...
            <div class="modal-body" style="min-height:300px;">
               <form class="form-addlowker" action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<textarea  class="textarea" name="txtBenefits" rows="5" cols="30" required></textarea>
                        <div class="help-block with-errors"></div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea name="txtWorkLocation" class="textarea"  required></textarea>
                        <div class="help-block with-errors"></div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea id="redactor" name="txtDescription" class="textarea" required></textarea>
                        <div class="help-block with-errors"></div>
                    </div>
