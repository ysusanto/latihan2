<div class="container">
		<div class="row">
			<div class="span12">
				<h1>Daftar Kategori Berita</h1><br />
				<div class="row">
					<!--sidebar menu -->
					...
					<div class="span9">
						<div class=""><!-- basic tabs menu -->
							<ul class="nav nav-tabs">
								...
								<li  class="active"><a href="<?php echo base_url(); ?>administrator/kategori_berita/">Kategori Berita</a></li>
							</ul>
						</div><!-- basic tabs menu -->
						<h5>Tambahkan Lagi Kategori berita</h5>
							...
							<?php } ?>
								...
								<div class="controls">
								<input placeholder="Ketik kategori berita.." name="nama_kategori" type="text" class="input" id="input01" value="<?php echo set_value('nama_kategori'); ?>">
						...
						<?php } ?>						
						<h5>Daftar Kategori Berita.</h5><br />
							<table class="table table-striped table-bordered"><!-- table default style -->
								...
								?>
									...
									<td>
										<a title="Edit Kategori" href="<?php echo base_url(); ?>administrator/edit_kategori_berita/<?php echo $row->id; ?>">
											<i class="icon-edit"></i> Edit | 
										<a href="#" onClick="if(confirm('Anda yakin HAPUS data ini?  Note: Menghapus Kategori mungkin dapat menyebabkan beberapa Berita ikut hilang terhapus, dikarenakan berita mempunyai kategori yang dipilih.')){document.location='<?php echo base_url()?>administrator/hapus_kategori/<?php echo $row->id; ?>'}" title="Hapus Kategori" >
