					...
					<div class="span9">
						...
						<?php } ?>
							<ul class="nav nav-tabs">
								<li class="active"><a href="<?php echo base_url(); ?>administrator/berita/">Daftar berita</a></li>
						...
						<h5>Daftar berita, diurutkan berdasarkan data dimutahirkan.</h5><br />
						<h5>Semua berita berjumlah sebanyak: <?php echo $count; ?> record(s).</h5><br />
							<table class="table table-striped table-bordered"><!-- table default style -->
								...
								?>
									...
									<td><?php echo ucwords($row->nama_berita); ?></td>
									<td>
										...
										<div class="modal-body">  
											<img src="<?php echo base_url(); ?>upload/berita/<?php echo $row->file_name; ?>" alt="">          
										</div>  
										...
										<a href="">
											<img  width="220px" src="<?php echo base_url(); ?>upload/berita/thumb/<?php echo $row->file_name; ?>" alt="">
										<!-- panggil modal -->
									...
									<td border="0">
										<a title="Edit berita berita" href="<?php echo base_url(); ?>administrator/edit_berita/<?php echo $row->id_berita; ?>">
											<i class="icon-edit"></i> Edit
										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>administrator/hapus_berita/<?php echo $row->id_berita; ?>'}" title="Hapus berita" >
