					...
					<div class="span9">
						<div class=""><!-- basic tabs menu -->
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="<?php echo base_url(); ?>administrator/tambah_berita/">Tambah berita</a></li>
								<li><a href="<?php echo base_url(); ?>administrator/kategori_berita/">Kategori berita</a></li>
							</ul>
						</div><!-- basic tabs menu -->
						
						<div class="well"><!-- div well & form -->
							<form class="form-horizontal" action="<?php echo base_url(); ?>administrator/submit_tambah_berita" method="POST" enctype="multipart/form-data">
							<fieldset>
							...
							<?php } ?>
								...
								<div class="controls">
								<input placeholder="Ketik nama berita.." name="nama_berita" type="text" class="input" id="input01" value="<?php echo set_value('nama_berita'); ?>">
							...
							<?php } ?>
									...
									<div class="controls">
										...
										<textarea placeholder="Masukan deskripsi berita.." name="deskripsi" style="width: 440px; height:340px;  rows="50" id="some-textarea"><?php echo set_value('deskripsi'); ?></textarea>
