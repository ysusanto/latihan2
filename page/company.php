...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.like').click(function(){
			...
			var $this = $(this);
			$.post("json.php?action=likecompany", {company_id:company_id,training_id:null,seeker_id:seeker_id}, function(data){
		...
		$('.dislike').click(function(){
			...
			var company_id = $(this).nextAll('div.comment-box').children('input.company_id').val();			
			var $this = $(this);
			$.post("json.php?action=dislikecompany", {company_id:company_id,training_id:null,seeker_id:seeker_id}, function(data){
				var json_obj = $.parseJSON(data);//parse JSON
				$.each(json_obj,function(i,e){
				 	$this.prevAll('span.like-total').html(e.like);
		...
		$('input.comment').keypress(function(event) {
			...
			if (key == 13) {
				...
				var $this = $(this);
				$.post('json.php?action=commentcompany', {company_id:company_id,seeker_id:seeker_id,comment:comment}, function(data){
					location.reload();
				})
			}
		});
