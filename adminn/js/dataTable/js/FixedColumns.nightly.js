...
FixedColumns.prototype = {
	...
	"_fnGridSetup": function ()
	{
		...
		this.dom.grid.dt.style.top = "0px";
                this.dom.grid.dt.style.overflow ='auto';
		this.dom.grid.dt.style.left = this.s.iLeftWidth+"px";
                
                var wDS = $(this.dom.grid.dt).width();
                var widthX = wDS-this.s.iLeftWidth;


                this.dom.grid.dt.style.width = (widthX)+"px";
		var sb = $('div.dataTables_scrollBody', this.dom.grid.dt);
		var wS = $(this.dom.grid.dt).width() - this.s.iLeftWidth;
                var tsb = $('table', sb)[0];
                tsb.style.width = (this.s.iLeftWidth +wS)+'px';
	},
