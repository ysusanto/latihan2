	...
	<?php
		...
		while ($row = mysql_fetch_assoc($rs)) {
			...
			echo "			<div class='comment-box'>
								...
								<input type='hidden' class='company_id' name='company_id' value='{$_SESSION['company_id']}'/>
			...
			while($comment = mysql_fetch_assoc($comments)){
				...
				else if ($comment['company_id']==null){ $name = $comment['firstname'].' '.$comment['lastname'];}
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.like').click(function(){
			...
			var $this = $(this);
			$.post("../json.php?action=liketraining", {training_id:training_id,company_id:company_id,seeker_id:null}, function(data){
		...
		$('.dislike').click(function(){
			...
			var company_id = $(this).nextAll('div.comment-box').children('input.company_id').val();			
			var $this = $(this);
			$.post("../json.php?action=disliketraining", {training_id:training_id,company_id:company_id,seeker_id:null}, function(data){
				var json_obj = $.parseJSON(data);//parse JSON
				$.each(json_obj,function(i,e){
				 	$this.prevAll('span.like-total').html(e.like);
		...
		$('input.comment').keypress(function(event) {
			...
			if (key == 13) {
				...
				var $this = $(this);
				$.post('../json.php?action=commenttraining', {training_id:training_id,company_id:company_id,comment:comment}, function(data){
					location.reload();
				})
			}
		});
